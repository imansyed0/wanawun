 ...
 *   2. Keep the Google Group publicly joinable AND publicly visible (Group
 *      settings > Privacy): "Who can join group" = "Anyone on the web can
 *      join", plus "Who can see group" / "Who can view conversations" =
 *      "Anyone on the web". Both matter -- joining permission alone still
 *      leaves the link above showing "not found" to non-members, who then
 *      never reach the Join button. "Ask to join" would leave them waiting
 *      for approval.
 *
